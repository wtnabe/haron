  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved snippet as @snippet" do
        ...
        post :create, {:snippet => { "source" => "invalid value" }}, valid_session
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested snippet" do
        ...
        Snippet.any_instance.should_receive(:update_attributes).with({ "source" => "MyText" })
        put :update, {:id => snippet.to_param, :snippet => { "source" => "MyText" }}, valid_session
      end
